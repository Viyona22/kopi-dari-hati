      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          ...
          <div className={`flex justify-center ${isMobile ? 'flex-col items-center gap-4' : 'gap-8'}`}>
            <img 
              src="https://cdn.builder.io/api/v1/image/assets/6881c5c08f454e4a8f857991aba7c465/ff4315eb0da02eb482b73b7cdf84a06c67a301e2?placeholderIfAbsent=true" 
              alt="Atmosphere 1" 
              className={`${isMobile ? 'w-full max-w-[280px] h-[200px]' : 'w-[163px] h-[240px]'} object-cover rounded-lg`} 
            />
            <img 
              src="https://cdn.builder.io/api/v1/image/assets/6881c5c08f454e4a8f857991aba7c465/eedabfc471dd01fb886ab3e7cd5be0c6759d4d3d?placeholderIfAbsent=true" 
              alt="Atmosphere 2" 
              className={`${isMobile ? 'w-full max-w-[280px] h-[200px]' : 'w-[163px] h-[240px]'} object-cover rounded-lg`} 
            />
          </div>
